...
\text{FIRST}(A) &= \gbr{\u{a}} \\
\text{FIRST}(B) &= \gbr{\u{b}} \cup \text{FIRST*}(C) \cup \text{FIRST*}(A)=\gbr{\u{a},\u{b},\u{c}} \\
\text{FIRST}(C) &= \gbr{\u{c},\varepsilon} \\
\text{FIRST}(D) &= \gbr{\u{c},\u{b}}
\end{align*}
\begin{align*}
\text{FOLLOW}(S) &= \gbr{\$} \\
\text{FOLLOW}(A) &= \text{FOLLOW}(S) \cup \text{FIRST*}(B) \cup \text{FOLLOW}(B)=\gbr{\$,\u{a},\u{b},\u{c}} \\
\text{FOLLOW}(B) &= \text{FOLLOW}(A)=\gbr{\$,\u{a},\u{b},\u{c}} \\
