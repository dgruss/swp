...
&\lra \rbr{\rbr{\I{P}{\omega}{lt?(x,plus(eins,eins))} \twedge \I{P}{\omega}{eq?(x,null)}} \tvee eq?(\I{T}{\omega}{x},\I{T}{\omega}{eins})} \tto F \\
&\lra \rbr{\rbr{lt?(\I{T}{\omega}{x},\I{T}{\omega}{plus(eins,eins)}) \twedge eq?(\I{T}{\omega}{x},\I{T}{\omega}{null})} \tvee eq?(\omega(\u{x}),1)} \tto F \\
&\lra \rbr{\rbr{lt?(\omega(\u{x}),plus(\I{T}{\omega}{eins},\I{T}{\omega}{eins})) \twedge eq?(\omega(\u{x}),0)} \tvee eq?(0,1)} \tto F \\
&\lra \rbr{\rbr{lt?(0,plus(1,1)) \twedge eq?(0,0)} \tvee F} \tto F \\
