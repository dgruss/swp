...
\begin{itemize}
\item Wenn $P(x_1,\ldots,x_n)=T$: $\I{E}{\delta,\omega}{$\Pi$}=T$ mit $\omega(\tu{xi})=x_i$
\item Wenn $P(x_1,\ldots,x_n)=F$: $\I{E}{\delta,\omega}{$\Pi$}=F$ mit $\omega(\tu{xi})=x_i$
\end{itemize}
...
\item[FALSE], d.h. $\I{E}{\delta,\omega}{A(x)}$ hält nicht.
Laut Definition der Interpretationsfunktion wird dann der \u{else}-Zweig ausgeführt.
\begin{align*}
&=\I{E}{\delta,\omega}{x} \\
&=\omega(\tu{x})
\end{align*}
