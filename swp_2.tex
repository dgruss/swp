...
&\Lra \rbr{\rbr{\I{P}{\omega}{lt?(x,plus(eins,eins))} \twedge \I{P}{\omega}{eq?(x,null)}} \tvee lt?(\omega(\tu{x}),1)} \tto F \\
&\Lra \neg\rbr{\rbr{\I{P}{\omega}{lt?(x,plus(eins,eins))} \twedge \I{P}{\omega}{eq?(x,null)}} \tvee lt?(\omega(\tu{x}),1)} \tvee F \\
&\Lra \neg\rbr{\rbr{\I{P}{\omega}{lt?(x,plus(eins,eins))} \twedge \I{P}{\omega}{eq?(x,null)}} \tvee lt?(\omega(\tu{x}),1)} \\
&\Lra \neg\rbr{\rbr{lt?(\I{P}{\omega}{x},\I{P}{\omega}{plus(eins,eins)}) \twedge eq?(\I{P}{\omega}{x},\I{P}{\omega}{null})} \tvee lt?(0,1)} \\
&\Lra \neg\rbr{\rbr{lt?(\omega(\tu{x}),\I{P}{\omega}{eins} + \I{P}{\omega}{eins}) \twedge eq?(\omega(\tu{x}),0)} \tvee lt?(0,1)} \\
&\Lra \neg\rbr{\rbr{lt?(0,1 + 1) \twedge eq?(0,0)} \tvee T}
\intertext{Damit wissen wir eigentlich schon genug, denn $\neg(\ldots \vee T) \Lra \neg T \Lra F$. Der Vollständigkeit halber rechnen wir hier weiter.}
&\Lra \neg\rbr{\rbr{lt?(0,2) \twedge T} \tvee T} \Lra \neg\rbr{\rbr{T \twedge T} \tvee T} \Lra \neg\rbr{T \tvee T} \Lra \neg T \Lra F
\end{align*}
