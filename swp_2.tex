...
In $\lng{E}$ hatten wir bereits Prädikate. Diese waren aber nur in Konditionalen (\u{if \textbf{predicate} then \ldots else \ldots}) an ganz bestimmten Stellen erlaubt.
...
\item Wenn $q \in \lng{P}$ ist, dann ist auch $\u{\neg}q \in \lng{P}$.
...
Formal schreiben wir dann: $\omega \sim_{v} \omega'$.
\end{defn}
...
\ifthenelse{\boolean{long}}{\begin{enumerate}}{\begin{compactenum}}
\item
$\Iu{P}{\omega}{p^{\Sigma}\tu{(}t_1\tu{,}\ldots\tu{,}t_n\tu{)}} = p\rbr{\Iu{P}{\omega}{t_1},\ldots,\Iu{P}{\omega}{t_n}}$, wenn $t_1,\ldots,t_n \in \lng{T}$,
...
\item $\Iu{P}{\omega}{\u{\neg}q} \lra \neg \Iu{P}{\omega}{q}$ (Negation)
\item $\Iu{P}{\omega}{\u{(}q\u{)}} \lra \Iu{P}{\omega}{q}$ (Klammerung)
\item $\Iu{P}{\omega}{\u{(\forall}v\u{)}q} \lra \forall \omega', \omega \sim_v \omega': \; \Iu{P}{\omega}{q}=T$ (All-Quantor)
\item $\Iu{P}{\omega}{\u{(\exists}v\u{)}q} \lra \exists \omega', \omega \sim_v \omega': \; \Iu{P}{\omega}{q}=T$ (Existenz-Quantor)
\ifthenelse{\boolean{long}}{\end{enumerate}}{\end{compactenum}}
\end{defn}
