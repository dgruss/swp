...
&\lra \rbr{\I{P}{\omega}{lt?(x,plus(eins,eins)) \twedge eq?(x,null)} \tvee eq?(\I{P}{\omega}{x},\I{P}{\omega}{eins})} \tto F \\
...
&\lra \rbr{lt?(\I{P}{\omega}{x},\I{P}{\omega}{plus(eins,eins)}) \twedge eq?(\I{P}{\omega}{x},\I{P}{\omega}{null})} \tto F \\
&\lra \rbr{lt?(\omega(\u{x}),plus(\I{P}{\omega}{eins},\I{P}{\omega}{eins})) \twedge eq?(\omega(\u{x}),0)} \tto F \\
...
&\lra \text{ist0?}(\omega(\u{x}))\to \rbr{\text{ist1?}(\I{P}{\omega}{y})\vee\text{istLeer?}(\I{P}{\omega}{y})} \\
...
&\lra \text{istLeer?}(\I{P}{\omega}{x})\wedge\text{ist1?}(\I{P}{\omega}{x}) \\
